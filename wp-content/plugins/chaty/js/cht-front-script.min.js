...
function close_chaty_contact_form(t) {
    ...
    function b() {
        var e, a, c = !1;
        if (n.length && t.each(n, (function(t, e) {
                q(e.triggers.has_countries) && !Q(e.triggers.countries) && e.triggers.countries.length && (c = !0)
            })), 1 == chaty_settings.has_CookieYes || 1 == chaty_settings.has_iubenda_cookie ? null == V("chaty_cookie_accepted") ? (R("chaty_cookie_accepted", !1, 365), v = V("chaty_cookie_accepted")) : v = V("chaty_cookie_accepted") : (e = "chaty_cookie_accepted", document.cookie = e + "=;expires=Thu, 01 Jan 1970 00:00:01 GMT;"), "false" == v) return !1;
        c ? "" != (i = P()) ? C() : (a = "https://www.cloudflare.com/cdn-cgi/trace", t.get(a, (function(t) {
            var e, a = t.match("loc=(.*)");
            a.length > 1 && (a = a[1]) && ("" == (a = a.toUpperCase()) && (a = "-"), e = a, "undefined" != typeof Storage ? null == window.sessionStorage.getItem("chaty_user_country_code") && window.sessionStorage.setItem("chaty_user_country_code", e) : X("chaty_user_country_code") || R("chaty_user_country_code", e, 365), C())
        }))) : C()
    }
    ...
    function C() {
        n.length && (t("body").append('<svg width="39" height="39" viewBox="0 0 39 39" class="hide-cht-svg-bg" fill="none" xmlns="http://www.w3.org/2000/svg"><defs> <linearGradient id="linear-gradient" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4a64d5"/> <stop offset="0.322" stop-color="#9737bd"/> <stop offset="0.636" stop-color="#f15540"/> <stop offset="1" stop-color="#fecc69"/> </linearGradient> <linearGradient id="linear-gradient-insta-dm" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4A64D5"></stop> <stop offset="0.322" stop-color="#9737BD"></stop> <stop offset="0.636" stop-color="#F15540"></stop> <stop offset="1" stop-color="#FECC69"></stop> </linearGradient></defs>'), t.each(n, (function(e, a) {
                var c = "",
                    ...
                    f = {},
                    w = function(e) {
                        if (q(e.triggers.has_countries) && !Q(e.triggers.countries) && e.triggers.countries.length && "-" != (i = P()) && -1 == t.inArray(i, e.triggers.countries)) return !1;
                        return !0
                    }(a);
                w = w && function(t) {
                    if (t.triggers.has_date_scheduling_rules) {
                        var e = t.triggers.date_scheduling_rules.start_date_time,
                            ...
                            c = new Date,
                            n = (c = H(c, t.triggers.time_diff)).getFullYear() + "-" + A(c.getMonth() + 1) + "-" + A(c.getDate()) + " " + A(c.getHours()) + ":" + A(c.getMinutes()) + ":" + A(c.getSeconds());
                        return "" == a && e <= n || ("" == e && a >= n || "" != e && "" != a && e <= n && a >= n)
                    }
                    return !0
                }(a), w = w && function(t) {
                    var e = !0;
                    if (q(t.triggers.has_day_hours_scheduling_rules) && t.triggers.day_hours_scheduling_rules.length > 0) {
                        var a = t.triggers.day_hours_scheduling_rules;
                        if (a.length > 0) {
                            e = !1;
                            for (var c = new Date, n = (c = H(c, t.triggers.day_time_diff)).getHours(), i = c.getMinutes(), s = c.getDay(), o = 0; o < a.length; o++) {
                                var h = 0,
                ...
                let C = "";
                if (v && (C = "has-chatway-channel"), (1 != g || !b) && w && g > 0 && !t("#chaty-widget-" + a.id).length) {
                    var M = U(a.settings);
                    M = "right" == M ? "right" : "left";
                    var T = z(a);
                    if ("chat-view" == a.settings.cta_type) {
                        var S = "<div style='display: none' class='chaty chaty-has-chat-view chaty-id-" + a.id + " chaty-widget-" + a.id + " chaty-key-" + e + "' id='chaty-widget-" + a.id + "' data-key='" + e + "' data-id='" + a.id + "' data-identifier='" + a.identifier + "' data-nonce='" + a.settings.widget_token + "' ><div class='chaty-widget " + M + "-position'><div class='chaty-channels'><div class='chaty-channel-list' id='csaas-channels-" + a.id + "'></div><div class='chaty-i-trigger csaas-widget-trigger " + C + "'></div></div></div></div>";
                        t("body").append(S),
                            function(e) {
                                var a = e.id,
                                    c = B(a);
                                ...
                                var n = e.settings.cta_body,
                                    ...
                                    s = t("title").text();
                                Q(s) ? (n = n.replace(/{title}/g, ""), i = i.replace(/{title}/g, "")) : (n = n.replace(/{title}/g, s), i = i.replace(/{title}/g, s));
                        ...
                        S = "<div style='display: none' class='chaty chaty-id-" + a.id + " chaty-widget-" + a.id + " chaty-key-" + e + "' id='chaty-widget-" + a.id + "' data-key='" + e + "' data-id='" + a.id + "' data-identifier='" + a.identifier + "' data-nonce='" + a.settings.widget_token + "' ><div class='chaty-widget " + M + "-position'><div class='chaty-channels'><div class='chaty-channel-list' id='csaas-channels-" + a.id + "'></div><div class='chaty-i-trigger csaas-widget-trigger " + C + "'></div></div></div></div>";
                        t("body").append(S)
                    }
                    q(a.triggers.auto_hide_widget) && parseInt(a.triggers.hide_after) > 0 && (t("#chaty-widget-" + a.id).addClass("auto-hide-chaty"), t("#chaty-widget-" + a.id).attr("data-time", a.triggers.hide_after));
                    var W = G(a.id, "c-widget");
                    if (t("#chaty-widget-" + a.id).addClass(a.settings.show_cta), 1 == g && "chat-view" != a.settings.cta_type) {
                        "vertical" != a.settings.icon_view && (T = "right" != M ? "right" : "left");
                        var E = I(f, a.id, T);
                        t("#chaty-widget-" + a.id + " .chaty-i-trigger").append(E), t("#chaty-widget-" + a.id + " .chaty-i-trigger").addClass("single-channel"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel").addClass("single"), t("#chaty-widget-" + a.id + " .chaty-widget").addClass("has-single");
                        var N = a.settings.cta_text;
                        "first_click" == a.settings.show_cta && (W ? (t("#chaty-widget-" + a.id + " .chaty-tooltip").removeClass("chaty-tooltip"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel").addClass("active").addClass("chaty-tooltip").addClass("pos-" + T), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel").append("<span class='on-hover-text'>" + N + "</span>").addClass("active").addClass("has-on-hover"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a").append("<span class='on-hover-text'>" + N + "</span>").addClass("has-on-hover"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a").attr("data-text", N)) : t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a").append("<span class='on-hover-text'>" + N + "</span>").removeClass("active").addClass("has-on-hover")), "all_time" == a.settings.show_cta && (t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-tooltip").append("<span class='on-hover-text'>" + N + "</span>").addClass("active").addClass("has-on-hover"), t("#chaty-widget-" + a.id + " .chaty-i-trigger.single-channel .chaty-channel a").attr("data-text", N));
                        var O = f;
                        ...
                        t.each(a.channels, (function(e, n) {
                            if (k(n) && ("Chatway" !== n.channel || "inside-chaty" === _ || "chat-view" === a.settings.cta_type)) {
                                if (L(n.channel_type) && (n.channel_type = n.channel), "chat-view" == a.settings.cta_type) {
                                    var i = I(n, a.id, "top");
                        ...
                        var V = function(t, e) {
                            ("" == t.widget_icon || "chat-image" == t.widget_icon && Q(t.widget_icon_url) || "chat-fa-icon" == t.widget_icon && Q(t.widget_fa_icon)) && (t.widget_icon = "chat-base");
                    ...
                    })), "chat-view" == a.settings.cta_type && a.settings.show_close_button, !(W = G(a.id, "c-widget")) || "open" == a.settings.default_state && 1 != g || (function(e, a) {
                        var c = G(a, "c-widget");
                        c && q(e.is_pending_mesg_enabled) && parseInt(e.pending_mesg_count) > 0 && (t("#chaty-widget-" + a + " .chaty-widget").hasClass("has-single") ? "sheen" == e.attention_effect || "spin" == e.attention_effect || "pulse" == e.attention_effect ? t("#chaty-widget-" + a + " .chaty-i-trigger .chaty-channel").append("<span class='ch-pending-msg'>" + e.pending_mesg_count + "</span>") : t("#chaty-widget-" + a + " .chaty-i-trigger .chaty-channel .chaty-svg").append("<span class='ch-pending-msg'>" + e.pending_mesg_count + "</span>") : "jump" == e.attention_effect || "waggle" == e.attention_effect || "blink" == e.attention_effect || "pulse-icon" == e.attention_effect || "floating" == e.attention_effect ? t("#chaty-widget-" + a + " .chaty-i-trigger .chaty-cta-main .chaty-cta-button").append("<span class='ch-pending-msg'>" + e.pending_mesg_count + "</span>") : t("#chaty-widget-" + a + " .chaty-i-trigger .chaty-cta-main").append("<span class='ch-pending-msg'>" + e.pending_mesg_count + "</span>"))
                    }(a.settings, a.id), function(e, a) {
                        var c = G(a, "c-widget");
                        c && "none" != e.attention_effect && "" != e.attention_effect && (t("#chaty-widget-" + a).attr("data-animation", e.attention_effect), t("#chaty-widget-" + a + " .chaty-widget").hasClass("has-single") ? t("#chaty-widget-" + a + " .chaty-i-trigger .chaty-channel .chaty-svg").addClass("chaty-animation-" + e.attention_effect) : t("#chaty-widget-" + a + " .chaty-i-trigger .chaty-cta-main .chaty-cta-button").addClass("chaty-animation-" + e.attention_effect))
                    }(a.settings, a.id));
                    var Z = 0;
                    if ("open" != a.settings.default_state || q(a.settings.show_close_button) || (t("#chaty-widget-" + a.id + " .chaty-widget").addClass("chaty-no-close-button").addClass("chaty-open"), Z = 1), v && (t("#chaty-widget-" + a.id + " .chaty-widget").addClass(_), "above-chaty" === _)) {
                    ...
                    q(a.settings.is_google_analytics_enabled) && (t("#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel > a").addClass("has-gae"), t("#chaty-form-" + a.id + "-chaty-chat-view .chaty-channel > a").addClass("has-gae"), t("#chaty-widget-" + a.id + " .chaty-i-trigger.single-channel .chaty-channel > a").addClass("has-gae"), t(".chaty-outer-forms.chaty-whatsapp-btn-form.chaty-form-" + a.id + " form.add-analytics").addClass("form-google-analytics"), t(".whatsapp-chaty-form-" + a.id).addClass("has-form-gae")), q(a.settings.has_custom_css) && !Q(a.settings.custom_css) && (h += a.settings.custom_css), "hover" == a.settings.default_state ? t("#chaty-widget-" + a.id).addClass("open-on-hover") : "open" == a.settings.default_state && (t("#chaty-widget-" + a.id + " .chaty-widget").addClass("default-open"), !W && q(a.settings.show_close_button) || t("#chaty-widget-" + a.id + " .chaty-widget:not(.has-single)").addClass("chaty-open"), W || t("#chaty-widget-" + a.id + " .chaty-widget").removeClass("default-open")), t("#chaty-widget-" + a.id + " .chaty-widget:not(.has-single):not(.chaty-no-close-button)").hasClass("default-open") ? q(a.settings.bg_blur_effect) && t("body").addClass("add-bg-blur-effect") : t("body").removeClass("add-bg-blur-effect"), q(a.settings.bg_blur_effect) && t("#chaty-widget-" + a.id + " .chaty-widget:not(.chaty-no-close-button)").addClass("has-bg-blur-effect");
                    var F = function(t) {
                        return t
                    ...
                    if (F = parseInt(F), c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel > a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel > a .chaty-custom-icon {display:block; width: " + F + "px; height: " + F + "px; line-height: " + F + "px; font-size: " + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel button {width: " + F + "px; height: " + F + "px; margin: 0; padding:0; outline: none; border-radius: 50%;}", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel .chaty-svg {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel .chaty-svg img {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel span.chaty-icon {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel .chaty-svg .chaty-custom-channel-icon {width: " + F + "px; height: " + F + "px; line-height: " + F + "px; display: block; font-size:" + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-cta-button {background-color: " + a.settings.widget_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-cta-button button {background-color: " + a.settings.widget_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel > a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel > a .chaty-custom-icon {display:block; width: " + F + "px; height: " + F + "px; line-height: " + F + "px; font-size: " + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel button {width: " + F + "px; height: " + F + "px; margin: 0; padding:0; outline: none; border-radius: 50%;}", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg img {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel span.chaty-icon {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg .chaty-custom-channel-icon {width: " + F + "px; height: " + F + "px; line-height: " + F + "px; display: block; font-size:" + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .ch-pending-msg {background-color: " + a.settings.pending_mesg_count_bgcolor + "; color: " + a.settings.pending_mesg_count_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg .widget-fa-icon {line-height: " + F + "px; font-size:" + parseInt(F / 2) + "px; }", "vertical" == a.settings.icon_view) {
                        ...
                        for (var J = 0; J <= g; J++) c += "#chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (J + 1) + ") {-webkit-transform: translateY(-" + (F + 8) * (g - J - Z) + "px); transform: translateY(-" + (F + 8) * (g - J - Z) + "px);}", c += "#chaty-widget-" + a.id + " .chaty-open.above-chaty.has-chatway .chaty-channel-list .chaty-channel:nth-child(" + (J + 1) + ") {-webkit-transform: translateY(-" + (F + 8) * (g - J - Z + 1) + "px); transform: translateY(-" + (F + 8) * (g - J - Z + 1) + "px);}";
                        if (v && "inside-chaty" == _) {
                            let t = 0,
                                e = 1;
                            for (let n = 0; n < p.length; n++) O = p[n], c += "body.chatway--active #chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel." + O.channel + "-link {-webkit-transform: translateY(-" + (F + 8) * (g - t - Z) + "px); transform: translateY(-" + (F + 8) * (g - t - Z) + "px);}", "Chatway" != O.channel ? c += "body:not(.chatway--active) #chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel." + O.channel + "-channel-link {-webkit-transform: translateY(-" + (F + 8) * (g - t - e - Z) + "px); transform: translateY(-" + (F + 8) * (g - t - e - Z) + "px);}" : e = 0, t++
                        } else {
                            let t = 0;
                            for (t = 0; t <= g; t++) c += "#chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateY(-" + (F + 8) * (g - t - Z) + "px); transform: translateY(-" + (F + 8) * (g - t - Z) + "px);}";
                            "above-chaty" == _ && (c += "#chaty-widget-" + a.id + " .chaty-channel-list .Chatway-channel-link {-webkit-transform: translateY(-" + (F + 8) * Z + "px); transform: translateY(-" + (F + 8) * (1 - Z) + "px);}")
                        }
                    } else {
                        ...
                        if (v && "inside-chaty" == _) {
                            let t = 0,
                                e = 1;
                            for (let n = 0; n < p.length; n++) O = p[n], c += "body.chatway--active .chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(" + (F + 8) * (g - t - Z) + "px); transform: translateX(" + (F + 8) * (g - t - Z) + "px);}", c += "body.chatway--active .chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(-" + (F + 8) * (g - t - Z) + "px); transform: translateX(-" + (F + 8) * (g - t - Z) + "px);}", "Chatway" != O.channel ? (c += "body:not(.chatway--active) #chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(" + (F + 8) * (g - t - e - Z) + "px); transform: translateX(" + (F + 8) * (g - t - e - Z) + "px);}", c += "body:not(.chatway--active) #chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(-" + (F + 8) * (g - t - e - Z) + "px); transform: translateX(-" + (F + 8) * (g - t - e - Z) + "px);}") : e = 0, t++
                        } else {
                            for (e = 0; e <= g; e++) c += "#chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (e + 1) + ") {-webkit-transform: translateX(" + (F + 8) * (g - e - Z) + "px); transform: translateX(" + (F + 8) * (g - e - Z) + "px);}", c += "#chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (e + 1) + ") {-webkit-transform: translateX(-" + (F + 8) * (g - e - Z) + "px); transform: translateX(-" + (F + 8) * (g - e - Z) + "px);}";
                            "above-chaty" == _ && (c += "#chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode .chaty-channel-list .Chatway-channel-link {-webkit-transform: translateX(" + (F + 8) * (1 - Z) + "px); transform: translateX(" + (F + 8) * (1 - Z) + "px);}", c += "#chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode .chaty-channel-list .Chatway-channel-link {-webkit-transform: translateX(-" + (F + 8) * (1 - Z) + "px); transform: translateX(-" + (F + 8) * (1 - Z) + "px);}")
                        }
                    }
                    ...
                    if (c += "#chaty-form-" + a.id + "-Whatsapp .chaty-whatsapp-body { max-height: calc(100vh - " + ct + "px); overflow-y: auto; }", G(a.id, "v-widget") && (q(a.triggers.exit_intent) || q(a.triggers.has_time_delay) || q(a.triggers.has_display_after_page_scroll) > 0) ? (q(a.triggers.has_time_delay) && 0 == parseInt(a.triggers.time_delay) ? (j(a.id), t("#chaty-widget-" + a.id).addClass("active")) : q(a.triggers.has_time_delay) && parseInt(a.triggers.time_delay) > 0 && (l = !0, parseInt(a.triggers.time_delay) > r && (r = a.triggers.time_delay), t("#chaty-widget-" + a.id).addClass("on-chaty-delay"), t("#chaty-widget-" + a.id).addClass("delay-time-" + parseInt(a.triggers.time_delay)), t("#chaty-widget-" + a.id).attr("data-time", parseInt(a.triggers.time_delay))), q(a.triggers.has_display_after_page_scroll) && 0 == parseInt(a.triggers.display_after_page_scroll) ? (j(a.id), t("#chaty-widget-" + a.id).addClass("active")) : q(a.triggers.has_display_after_page_scroll) && parseInt(a.triggers.display_after_page_scroll) > 0 && (d = !0, t("#chaty-widget-" + a.id).addClass("on-chaty-scroll"), t("#chaty-widget-" + a.id).addClass("page-scroll-" + parseInt(a.triggers.display_after_page_scroll)), t("#chaty-widget-" + a.id).attr("data-scroll", parseInt(a.triggers.display_after_page_scroll))), q(a.triggers.exit_intent) && (y = !0, t("#chaty-widget-" + a.id).addClass("on-chaty-exit-intent"))) : (j(a.id), t("#chaty-widget-" + a.id).addClass("active")), !Q(a.settings.font_family) && "none" != a.settings.font_family) {
                ...
                y && (s ? function() {
                    ...
                    e = (e = e.replace(/{title}/g, x())).replace(/{url}/g, window.location.href), t(this).attr("href", e)
                })), t(document).on("click", "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel", (function() {
                    t(this).closest(".chaty-widget").hasClass("has-single") ? t(this).closest(".chaty").hasClass("form-open") && (q(a.settings.bg_blur_effect) ? t("body").addClass("add-bg-blur-effect") : t("body").removeClass("add-bg-blur-effect")) : t(this).closest(".chaty-widget").hasClass("chaty-open") ? t("body").removeClass("add-bg-blur-effect") : t(this).closest(".chaty-widget").hasClass("chaty-no-close-button") || q(a.settings.bg_blur_effect) && t("body").addClass("add-bg-blur-effect")
                }))
            })), t("#custom-advance-chaty-css").length || t("head").append("<style id='custom-advance-chaty-css'></style>"), t("#custom-advance-chaty-css").append(u), (t(".v3_site_key").length && !Q(t(".v3_site_key").val()) || t(".v2_site_key").length && !Q(t(".v2_site_key").val())) && function() {
            ...
            function() {
                ...
                l && (a = setInterval((function() {
                    (p++, t(".chaty.delay-time-" + p).length) && E(t(".chaty.delay-time-" + p).data("id"))
                }), 1e3));
                if (d) {
                            ...
                            if (0 != e) {
                                ...
                                if (f <= c) {
                                    ...
                                    for (var i = n; i <= c; i++) - 1 == t.inArray(i, g) && t(".chaty.on-chaty-scroll.page-scroll-" + i).length && t(".chaty.on-chaty-scroll.page-scroll-" + i).each((function() {
                                        ...
                                        t(this).removeClass("on-chaty-scroll"), E(e)
                                    }));
                                    f = c
                                }
                            }
    ...
    function k(t) {
        if (q(t.is_agent)) {
            if (t.agent_data.length && (!s && q(t.is_agent_desktop) || s && q(t.is_agent_mobile))) return !0
        } else if ((!s && q(t.is_desktop) || s && q(t.is_mobile)) && ("" != t.value || "Contact_Us" == t.channel || "Chatway" == t.channel)) return !0;
        return !1
    }
    ...
    function j(a) {
        if (t("#chaty-widget-" + a + " .chaty-channel.chaty-default-open").length) {
            ...
            if (!Q(c)) {
                ...
                if (i && (t("#" + c).addClass("is-active"), t("#" + c).length)) {
                    ...
                    if (_(a), t("#chaty-widget-" + a).find(".ch-pending-msg").remove(), t("#chaty-widget-" + a + " .chaty-widget").removeClass("chaty-open"), t("#chaty-widget-" + a).addClass("form-open"), t("#" + c).addClass("active"), t("#chaty-widget-" + a + " .chaty-widget:not(.chaty-no-close-button)").hasClass("has-bg-blur-effect") && t("body").addClass("add-bg-blur-effect"), setTimeout((function() {
                    ...
                    if ("on" == chaty_settings.data_analytics_settings) {
                        ...
                        if (G(a, "v-" + r) && void 0 !== r && (N(a, "v-" + r), l.push(r)), !h && l.length) {
        ...
        if (g) {
            ...
            if (t("#chaty-widget-" + a + " .chaty-widget").hasClass("has-single")) p = 1, r = t("#chaty-widget-" + a + " .chaty-channel").data("channel"), G(a, "v-" + r) && void 0 !== r && (N(a, "v-" + r), l.push(r));
                ...
                chatyChannel = t(this).data("channel"), (i = G(a, "v-" + chatyChannel)) && "undefined" != typeof chatyChannel && (N(a, "v-" + chatyChannel), l.push(chatyChannel))
            })) : t("#chaty-widget-" + a + " .chaty-channel-list .chaty-channel").each((function() {
                r = t(this).data("channel"), G(a, "v-" + r) && void 0 !== r && (N(a, "v-" + r), l.push(r))
            })));
            if (g && !h) {
    ...
    function I(e, a, c) {
        var n = "";
        if (!q(e.is_agent)) {
            L(e.channel_type) && (e.channel_type = e.channel);
            o = S(e, W(e), c, a);
            if ("Contact_Us" == e.channel_type) n += " has-chaty-box chaty-contact-form";
            else if ("Whatsapp" == e.channel_type) {
                if (q(e.is_default_open)) G(a, "c-" + e.channel_type) && (n += " chaty-default-open")
            }
    ...
    function S(e, a, c, n) {
        var i = "";
        if (q(e.is_agent)) e.url = "javascript:;", e.target = "";
        else if ("Whatsapp" == e.channel_type)
            if (q(e.has_welcome_message)) e.url = "javascript:;", e.target = "", i += " has-chaty-box chaty-whatsapp-btn-form",
                function(e, a) {
                    const c = new Date;
                    ...
                    var l = "https://web.whatsapp.com/send",
                        r = "";
                    s ? l = "https://wa.me/" + e.value : (l = q(e.is_use_web_version) ? "https://web.whatsapp.com/send" : "https://wa.me/" + e.value, r = "_blank");
                    ...
                    var d = Q(e.wp_popup_headline) ? "" : e.wp_popup_headline;
            ...
            c += "<div style='display:none;' class='chaty-outer-forms chaty-contact-form-box chaty-form-" + a + "' data-channel='" + e.channel_type + "' id='chaty-form-" + a + "-" + e.channel_type + "' data-widget='" + a + "' data-index='" + n + "'>", c += "<div class='chaty-form'>", c += "<div class='chaty-form-body'>", c += "<div role='button' class='close-chaty-form'><div aria-hidden='true' class='chaty-close-button'></div><span class='hide-cht-svg-bg'>" + chaty_settings.lang.hide_whatsapp_form + "</span></div>", c += "<form class='chaty-ajax-contact-form' id='chaty-ajax-contact-form-" + n + "' method='post' data-channel='" + e.channel_type + "' data-widget='" + a + "' data-token='" + e.widget_token + "' data-index='" + e.widget_index + "' enctype='multipart/form-data'>", c += "<div class='chaty-contact-form-body'>", c += "<div class='chaty-contact-form-title'><div class='form-title'>" + e.contact_form_settings.contact_form_title + "</div><div aria-hidden='true' class='chaty-close-button'><span class='hide-cht-svg-bg'>" + chaty_settings.lang.hide_whatsapp_form + "</span><svg width='15' height='9' viewBox='0 0 15 9' fill='none' xmlns='http://www.w3.org/2000/svg'> <path d='M1 1L7.31429 8L14 1' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'></path></svg></div></div>", c += "<div class='chaty-contact-inputs'>", t.each(e.contact_fields, (function(e, n) {
                ...
                var i = q(n.is_required) ? "is-required" : "",
                    s = "";
                q(n.is_required) && (s = "<span class='required_indicate'>*</span>"), q(n.is_custom) ? (c += "<label class='chaty-form-label' for='" + n.field_dropdown + "-" + e + "'>" + n.field_label + " " + s + "</label>", c += "<input type='hidden' name='custom_fields[" + e + "][label_" + n.field_dropdown + "]' value='" + n.field_label + "'>", c += "<input type='hidden' name='custom_fields[" + e + "][slug]' value='" + n.field_dropdown + "'>", "text" == n.field_dropdown || "url" == n.field_dropdown || "date" == n.field_dropdown ? c += "<input type='" + n.field_dropdown + "' class='chaty-input-field " + i + " field-" + n.field_dropdown + "' placeholder='" + n.placeholder + "' name='custom_fields[" + e + "][" + n.field_dropdown + "]' id='" + n.field_dropdown + "-" + e + "' />" : "file" == n.field_dropdown ? c += "<input type='file' class='chaty-input-field " + i + " field-" + n.field_dropdown + "' name='custom_fields[" + e + "][" + n.field_dropdown + "]' id='" + n.field_dropdown + "-" + e + "' accept='.jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.ppt,.pptx,.pps,.ppsx,.odt,.xls,.xlsx,.mp3,.mp4,.wav,.mpg,.avi,.mov,.wmv,.3gp,.ogv' multiple/>" : "textarea" == n.field_dropdown ? c += "<textarea class='chaty-textarea-field " + i + " field-" + n.field_dropdown + "' placeholder='" + n.placeholder + "' name='custom_fields[" + e + "][" + n.field_dropdown + "]' id='" + n.field_dropdown + "-" + e + "' ></textarea>" : "dropdown" == n.field_dropdown ? (c += "<select name='custom_fields[" + e + "][" + n.field_dropdown + "]' class='chaty-input-field " + i + "'>", n.dropdown_placeholder && (c += "<option value=''>" + n.dropdown_placeholder + "</option>"), t.each(n.dropdown_option, (function(t, e) {
            ...
            })), q(e.enable_recaptcha) && (Q(e.v2_site_key) || (c += "<div class='chaty-contact-input'>", c += "<div class='front-google-captcha' id='front_recaptcha_" + n + "'></div>", c += "</div>"), Q(e.v3_site_key) || (c += "<div class='chaty-contact-input'>", c += "<div class='front-google-captcha' id='front_recaptcha_" + n + "'></div>", c += "</div>"));
            c += "</div>", c += "<div class='chaty-contact-form-button'><button type='submit' id='chaty-submit-button-" + a + "' class='chaty-submit-button'>" + e.contact_form_settings.button_text + "<span class='chaty-loader'><span class='dashicons dashicons-update'></span></span></button></div>", c += "</div>", c += "<input type='hidden' name='nonce' value='" + e.widget_token + "'>", c += "<input type='hidden' name='action' value='chaty_front_form_save_data'>", c += '<input type="hidden" name="channel" value="' + e.channel_type + '">', c += '<input type="hidden" name="widget" value="' + a + '">', c += '<input type="hidden" name="ref_url" value="' + window.location.href + '">', c += '<input type="hidden" name="token" value="' + googleV3Token + '">', c += '<input type="hidden" name="page_id" value="' + chaty_settings.page_id + '">', c += '<input type="hidden" name="page_title" value="' + x() + '">';
            var i = t(".g-recaptcha-response").length ? t(".g-recaptcha-response").val() : "";
            c += '<input type="hidden" name="v2token" value="' + i + '">', q(e.enable_recaptcha) && (Q(e.v2_site_key) || (c += "<input type='hidden' id='v2_site_key' class='v2_site_key' value='" + e.v2_site_key + "'>"), Q(e.v3_site_key) || (c += "<input type='hidden' id='v3_site_key' class='v3_site_key' value='" + e.v3_site_key + "'>"));
            ...
            if (!Q(e.mail_subject)) {
                ...
                l = (l = Q(h = t("title").text()) ? l.replace(/{title}/g, "") : l.replace(/{title}/g, h)).replace(/{url}/g, window.location), l = encodeURIComponent(l), e.url += "?subject=" + l
            }
    ...
    function z(t) {
        return "vertical" != t.settings.icon_view ? "top" : "right" == U(t.settings) ? "left" : "right"
    }

    function D() {
        y && t(".on-chaty-exit-intent").length && t(".on-chaty-exit-intent").each((function() {
            var e = t(this).data("id");
            t(this).removeClass("on-chaty-exit-intent"), E(e), t("#chaty-widget-" + e + " .chaty-widget").append("<div class='chaty-exit-intent'></div>"), setTimeout((function() {
    ...
    function O() {
        t(".chaty-widget.default-open.has-bg-blur-effect").length && t(".chaty-widget.default-open.has-bg-blur-effect").each((function() {
            N(t(this).closest(".chaty").data("id"), "c-widget")
        }))
    }
    ...
    t(document).ready((function() {
        ...
        a.test(c) && (h = !0), s ? t("body").addClass("cht-in-mobile") : t("body").addClass("cht-in-desktop"), q(chaty_settings.has_chatway) && t("body").addClass("csaas-has-chatway"), "undefined" == typeof chaty_settings ? (console.log("Chaty settings doesn't exists"), chatyInterval = setInterval((function() {
            "object" == typeof chaty_settings && (clearInterval(chatyInterval), "object" != typeof chaty_settings || "on" == chaty_settings.data_analytics_settings && "off" != chaty_settings.data_analytics_settings || (h = !0), q(chaty_settings.has_chatway) && t("body").addClass("csaas-has-chatway"), n = chaty_settings.chaty_widgets, b())
            ...
            t(".chaty-popup-whatsapp-form.active").length && t(".chaty-popup-whatsapp-form.active").each((function() {
                var e = t(this).data("widget"),
                    a = G(e, "c-Whatsapp");
                Q(e) && 0 != e || !a || N(e, "c-Whatsapp")
            })), t(".form-open").removeClass("form-open"), t(".chaty-outer-forms").removeClass("active"), t(".chaty .chaty-widget.chaty-no-close-button:not(.has-single)").addClass("chaty-open"), t(".chaty .chaty-widget").hasClass("chaty-open") && (t(".chaty .chaty-widget:not(.chaty-no-close-button)").removeClass("chaty-open"), t("body").removeClass("add-bg-blur-effect")), t("body").removeClass("add-bg-blur-effect"), R("hide-bg-blur-effect", !0, 365), O()
            ...
            t(this).closest(".chaty").find(".chaty-widget").removeClass("chaty-open"), t("body").removeClass("add-bg-blur-effect"), R("hide-bg-blur-effect", !0, 365), O()
            ...
            t("#chaty-widget-" + c).length && (t("#chaty-widget-" + c).removeClass("form-open"), t(this).closest(".chaty-outer-forms").removeClass("active"), t("#chaty-widget-" + c).find(".chaty-widget").hasClass("cssas-no-close-button") && t("#chaty-widget-" + c).find(".chaty-widget:not(.has-single)").addClass("chaty-open")), t("body").hasClass("add-bg-blur-effect") && (t("body").removeClass("add-bg-blur-effect"), O())
            ...
            if (!Q(a) || 0 == a) {
                ...
                t(this).hasClass("whatsapp-form-close-btn") && (n = G(a, "c-Whatsapp"), Q(a) && 0 != a || !n || N(a, "c-Whatsapp"))
            }
            t("body").removeClass("add-bg-blur-effect")
            ...
            if (t(this).closest(".chaty").hasClass("form-open")) {
                ...
                t("#chaty-form-" + e + "-Whatsapp").length && t("#chaty-form-" + e + "-Whatsapp").hasClass("active") && (clickStatus = G(e, "c-Whatsapp"), Q(e) && 0 != e || !clickStatus || N(e, "c-Whatsapp"))
            }
            ...
            var e = t(this).closest(".chaty").data("id");
            t(this).closest(".chaty").hasClass("first_click") && t(this).closest(".chaty-channel").removeClass("active"), _(e)
            ...
            if (void 0 !== o && void 0 !== t("#chaty-widget-" + o).data("identifier")) {
                ...
                if (_(o), t(this).closest(".chaty-channel").hasClass("chaty-cta-main") || t(this).closest(".chaty-channel").hasClass("chaty-cta-close")) {
                    if (t("#chaty-form-" + o + "-Whatsapp").length && t("#chaty-form-" + o + "-Whatsapp").hasClass("active") && (a = G(o, "c-Whatsapp"), Q(o) && 0 != o || !a || N(o, "c-Whatsapp")), a = G(o, "c-widget"), t("#chaty-widget-" + o).find(".ch-pending-msg").remove(), a && (N(o, "c-widget"), t(this).closest(".chaty-channel").hasClass("chaty-cta-main"))) {
                        n = [], t("#chaty-widget-" + o).hasClass("chaty-has-chat-view") ? t(".chaty-chat-view.chaty-chat-view-" + o + " .chaty-view-channels").find(".chaty-channel").each((function() {
                            c = t(this).data("channel"), (a = G(o, "v-" + c)) && void 0 !== c && (N(o, "v-" + c), n.push(c))
                    ...
                    a && (N(o, "c-widget"), i = 0, n = [], c = t(this).closest(".chaty-channel").data("channel"), (a = G(o, "c-" + c)) && (n.push(c), i = 1), h || t.ajax({
                        url: chaty_settings.ajax_url,
                        data: {
                            widgetId: o,
                            userId: l,
                        ...
                        if ("" != googleV3Token && (googleV3Token = "", refreshG3Token()), t(".chaty-ajax-error-message").remove(), t(".chaty-ajax-success-message").remove(), t(".chaty-submit-button").attr("disabled", !1), 1 == e.status) {
                            ...
                            "yes" == e.close_form_after && setTimeout((function() {
                                if (t(".chaty-outer-forms.active").length) {
                                    ...
                                    Q(e) && 0 != e || t("#chaty-widget-" + e).length && (t("#chaty-widget-" + e).removeClass("form-open"), t("body").removeClass("add-bg-blur-effect"), t(".chaty-outer-forms.active").removeClass("active"), t("#chaty-widget-" + e).find(".chaty-widget").hasClass("chaty-no-close-button") && t("#chaty-widget-" + e).find(".chaty-widget:not(.has-single)").addClass("chaty-open"))
                                }
        ...
        })), t(document).on("click", ".iubenda-cs-accept-btn, .iubFooterBtn #wt-cli-privacy-save-btn, #wt-cli-accept-all-btn, #cookie_action_close_header, .cky-btn-accept", (function() {
            R("chaty_cookie_accepted", !0, 365), b()
        })), t(document).on("click", ".iubenda-cs-reject-btn, .cky-btn-customize, .cky-btn-preferences, .cky-btn-reject", (function() {
            R("chaty_cookie_accepted", !1, 365), t(".chaty.active").removeClass("active")
        })), document.addEventListener("cookieyes_consent_update", (function() {
            const e = V("cookieyes-consent");
            if (e) {
                "yes" === function(t) {
                    const e = {};
                ...
                }(e).consent ? (R("chaty_cookie_accepted", !0, 365), b()) : (R("chaty_cookie_accepted", !1, 365), t(".chaty.active").removeClass("active"))
            }
        }))
