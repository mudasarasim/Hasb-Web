...
(function($) {
    ...
    $.fn.wonderplugin3dcarousel = function(options) {
        ...
        LegacyCarousel.prototype = {
            ...
            gotoItem: function(itemId) {
                ...
                this.curItem = itemId;
                this.container.trigger("wonderplugin3dcarousel.beforeswitch", [this.prevItem,
                    this.curItem
                ]);
                var items = $(".wonderplugin3dcarousel-item", this.container);
                items.css({
                    ...
                    if (dir < 0)
                        for (var i = 0; i <= this.sideCount; i++) {
                            ...
                            items.eq(sideItem).css({
                                "margin-left": "-" + (this.itemW / 2 + this.itemW * (i - dir)) + "px"
                            })
                        } else if (dir > 0)
                            for (var i = 0; i <= this.sideCount; i++) {
                                var sideItem = this.curItem + i;
                                if (sideItem >= this.totalItems) {
                                    if (!this.options.loop) break;
                                    sideItem =
                                        sideItem - this.totalItems
                                }
                                items.eq(sideItem).css({
                                    "margin-left": this.itemW / 2 + this.itemW * (i + dir - 1) + "px"
                                })
                            }
                var instance = this;
                setTimeout(function() {
                    ...
                    if (instance.parentObject.autosliding && !instance.parentObject.isMousePaused && !instance.parentObject.isVideoPaused) {
                        var islast = instance.options.autoslidedir == "right" && instance.curItem >= instance.totalItems - 1 || instance.options.autoslidedir ==
                            "left" && instance.curItem <= 0;
                ...
                if (instance.options.onlyenableweblinkoncenter) {
                    $(".wonderplugin3dcarousel-item .wonderplugin3dcarousel-item-weblink", instance.container).css({
                        cursor: "default"
                    });
                    $(".wonderplugin3dcarousel-item-current .wonderplugin3dcarousel-item-weblink", instance.container).css({
                        cursor: "pointer"
                    })
                }
            },
                ...
                if (pos < 0)
                    for (var i = 1; i <= Math.abs(pos); i++) {
                        ...
                        if (!items.eq(sideItem).hasClass(".wonderplugin3dcarousel-item-visible")) items.eq(sideItem).css({
                            "margin-left": this.itemW /
                                2 + this.itemW * (i + this.sideCount - 1) + "px"
                        })
                    } else
                        for (var i = 1; i <= Math.abs(pos); i++) {
                            var sideItem = this.curItem - this.sideCount - i;
                            ...
                            if (!items.eq(sideItem).hasClass(".wonderplugin3dcarousel-item-visible")) items.eq(sideItem).css({
                                "margin-left": "-" + (this.itemW / 2 + this.itemW * (i + this.sideCount)) + "px"
                            })
                        }
            }
        };
        ...
        ThreeDSlider.prototype = {
            ...
            gotoItem: function(itemId) {
                ...
                if (this.totalItems > this.visibleitems)
                    if (dir < 0)
                        for (var i = 0; i <= this.sideCount; i++) {
                            ...
                            items.eq(sideItem).css({
                                transform: "translateX(-" + this.xdis * (i - dir) + "px) translateZ(-" + this.zdis * (i - dir) + "px) rotateY(" + this.yrotate + "deg)"
                            })
                        } else if (dir > 0)
                            for (var i = 0; i <= this.sideCount; i++) {
                                var sideItem = this.curItem + i;
                ...
                setTimeout(function() {
                    ...
                    if (instance.parentObject.autosliding && !instance.parentObject.isMousePaused && !instance.parentObject.isVideoPaused) {
                        var islast =
                            instance.options.autoslidedir == "right" && instance.curItem >= instance.totalItems - 1 || instance.options.autoslidedir == "left" && instance.curItem <= 0;
                        if (!islast || instance.options.loop || instance.options.loopslide) instance.parentObject.slideTimeout.start()
                    }
                }, 10);
                if (instance.options.onlyenableweblinkoncenter) {
            ...
            goAnimation: function(pos) {
                ...
                items.eq(this.curItem).data("pos",
                    0).addClass("wonderplugin3dcarousel-item-visible");
                if (this.totalItems <= 1) return;
                for (var i = 1; i <= this.sideCount; i++) {
                    var sideItem = this.curItem - i;
                    if (sideItem < 0) {
        ...
        ThreeDCarousel.prototype = {
            ...
            gotoPrev: function() {
                var itemId = this.curItem - 1;
                if (itemId < 0) itemId = this.options.loop ||
                    this.options.loopslide ? this.totalItems - 1 : 0;
                this.gotoItem(itemId)
            },
            gotoNext: function() {
                var itemId = this.curItem + 1;
            ...
            gotoItem: function(itemId) {
                ...
                items.each(function(index) {
                    ...
                    $(this).data("translatex",
                        xdis).data("translatey", ydis).data("translatez", zdis).data("rotatex", instance.options.rotatex).data("rotatey", rotatey)
                });
        ...
        WP3DCarousel.prototype = {
            ...
            init: function() {
                ...
                else switch (this.options.template) {
                    case "3dcarousel":
                        this.carouselObject =
                ...
                $(window).trigger("wonderplugin3dcarousel.inited");
                if (!this.options.autoslide && this.options.autoslidewhenscrollinview) {
                    ...
                    } else $(window).on("scroll.wonderplugin3dcarousel", function() {
                        if (instance.autosliding) {
                            $(this).off("scroll.wonderplugin3dcarousel");
                            return
                        }
            ...
            initEnv: function() {
                ...
                this.isIE11 = navigator.userAgent.match(/Trident\/7/) != null && navigator.userAgent.match(/rv:11/) !=
                    null;
            ...
            initVideoButton: function() {
                ...
                $(".wonderplugin3dcarousel-img", this.container).each(function(index) {
                    ...
                    if (isVideo) $(this).closest(".wonderplugin3dcarousel-img-container").css({
                        cursor: "pointer"
                    }).click(function() {
            ...
            playMp4Video: function(href, webmhref, autoplay, $videoWrapper) {
                ...
                if (this.isFirefox || this.isOpera)
                    if (!this.canplaymp4 && !webmhref) this.isHTML5 = false;
                if (this.isHTML5) {
                    var videoSrc = href;
                    if (this.isFirefox || this.isOpera)
            ...
            embedHTML5Video: function($container, src, autoPlay) {
                if (this.isFirefox && this.options.nativecontrolsonfirefox || (this.isIE || this.isIE11) && this.options.nativecontrolsonie || this.isIPhone && this.options.nativecontrolsoniphone || this.isIPad && this.options.nativecontrolsonipad || this.isAndroid && this.options.nativecontrolsonandroid) this.options.nativehtml5controls = true;
                if (this.isIPhone || this.isIPad || this.isAndroid) this.options.nativecontrolsonfullscreen = true;
                $container.html("<div class='wonderplugin3dcarousel-video-container-" +
                    this.id + "' style='position:relative;display:block;width:100%;height:100%;'><video class='threed-inline-video' style='width:100%;height:100%;margin:0;padding:0;'" + (this.options.nativehtml5controls && !this.options.videohidecontrols ? " controls='controls'" : "") + (this.options.nativecontrolsnodownload ? " controlsList='nodownload'" : "") + "></div>");
            ...
            initOverlay: function() {
                ...
                if (this.options.applylinktohoveroverlay) {
                    $(".wonderplugin3dcarousel-hoveroverlay", this.container).each(function() {
                        ...
                        if (imgContainer.length > 0 && imgContainer.parent().is("a")) $(this).css({
                            cursor: "pointer"
                        })
                    });
                ...
                $(".wonderplugin3dcarousel-item",
                    ...
                    if ($(".wonderplugin3dcarousel-hoveroverlay", this).length > 0) {
                        if ($(".wonderplugin3dcarousel-content", this).length > 0 && instance.options.imghovereffect == "flipy") $(".wonderplugin3dcarousel-content", this).addClass("wonderplugin3dcarousel-" + instance.options.imghovereffect + "-out");
            ...
            initLightbox: function() {
                ...
                $(".wp3dcarousellightbox-" + this.id).each(function() {
                    var title =
                        $(this).data("title") ? $(this).data("title") : $(this).attr("title");
                    ...
                    instance.lightboxObject.addItemNoDuplicate($(this).attr("href"), title, $(this).data("group"), $(this).data("width"), $(this).data("height"),
                        $(this).data("webm"), $(this).data("ogg"), $(this).data("thumbnail"), description, $(this).data("mediatype"))
                });
                ...
                if (instance.options.onlyenablelightboxoncenter) instance.container.on("wonderplugin3dcarousel.beforeswitch",
                    function() {
                        $(".wp3dcarousellightbox-" + instance.id).each(function() {
                            var index = $(this).closest(".wonderplugin3dcarousel-item").index();
                            $(this).css({
                                cursor: index == instance.carouselObject.curItem ? "pointer" : "default"
                            });
            ...
            updateText: function(index) {
                ...
                if (this.options.showbutton) {
                    ...
                    if (itembutton.length) $(".wonderplugin3dcarousel-button", this.container).append(itembutton.clone(true).css("display", "block"))
                }
            ...
            createText: function() {
                ...
                this.container.on("wonderplugin3dcarousel.switch", function(e, prev, cur) {
                    if (cur >= 0 && cur < instance.elemLength)
                        if (instance.options.texteffect == "fade") $(".wonderplugin3dcarousel-text",
                            instance.container).fadeOut(function() {
                ...
                this.container.on("wonderplugin3dcarousel.switch",
                    function(e, prev, cur) {
                        if (!instance.options.loop && !instance.options.loopside) {
                            $(".wonderplugin3dcarousel-prev", instance.container).css({
                                visibility: cur == 0 ? "hidden" : "visible"
                            });
                            $(".wonderplugin3dcarousel-next", instance.container).css({
                                visibility: cur == instance.elemLength - 1 ? "hidden" : "visible"
                            })
                        }
                    })
            },
            ...
            bulletNormal: function(bullet) {
                if (this.carouselObject.curItem ==
                    bullet.data("bulletindex")) return;
        ...
        this.each(function() {
            ...
            for (var i = 0; i < imageList.length; i++)
                if (this.options[imageList[i]].substring(0, 7).toLowerCase() != "http://" && this.options[imageList[i]].substring(0, 8).toLowerCase() != "https://") this.options[imageList[i]] = this.options.jsfolder + this.options[imageList[i]];
            this.options.mtext = true;
            var lightboxOptions = {
                ga4account: this.options.ga4account,
                googleanalyticsaccount: this.options.googleanalyticsaccount,
                inityoutube: this.options.lightboxinityoutube,
                initvimeo: this.options.lightboxinitvimeo,
                ...
                loopvideo: this.options.lightboxloopvideo,
            ...
            if ($("#wp3dcarousellightbox_advanced_options_" + this.options.carouselid).length) $.each($("#wp3dcarousellightbox_advanced_options_" + this.options.carouselid).data(), function(key, value) {
                lightboxOptions[key.toLowerCase()] = value
            });
    ...
    $(document).ready(function() {
        $(".wonderplugin-3dcarousel-engine").css({
            display: "none"
        });
