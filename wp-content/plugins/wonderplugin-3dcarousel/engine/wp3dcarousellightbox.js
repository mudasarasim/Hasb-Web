...
function load3DCarouselHtml5LightBox(jsFolder) {
    (function($) {
        $.fn.wp3dcarousellightbox = function(options) {
            ...
            inst.options = $.extend({
                ...
                version: "3.3",
                stamp: true,
                freemark: "87,111,114,100,80,114,101,115,115,32,51,68,32,67,97,114,111,117,115,101,108,32,84,114,105,97,108,32,86,101,114,115,105,111,110",
                watermark: "",
                watermarklink: ""
            }, options);
            ...
            if (inst.options.enablega4 && inst.options.ga4account && typeof gtag !== "function") {
                ...
                $.getScript("https://www.googletagmanager.com/gtag/js?id=" +
                    encodeURIComponent(inst.options.ga4account))
            }
            ...
            inst.disableKeyOutsideOfLightbox = function(event) {
                if ($(event.target).closest("#threedcarousel-html5-lightbox").length <=
                    0) {
            ...
            inst.init = function() {
                ...
                if (inst.options.onvideofinishurl) $(window).on("html5lightbox.videofinished", function() {
                    window.open(inst.options.onvideofinishurl, inst.options.onvideofinishurltarget)
                })
            };
            ...
            inst.readNodeData = function(node, parentNode) {
                ...
                if (!title && node.find("img").length > 0) {
                    ...
                    title = img.attr("title") ?
                        img.attr("title") : img.attr("alt") ? img.attr("alt") : ""
                }
                ...
                var smallw = inst.checkParentClass(node,
                    parentNode, "smallwidth");
                ...
                var newItem = new Array(fileType, node.attr("href"), title, group, w, h, inst.checkParentData(node, parentNode, "webm"), inst.checkParentData(node, parentNode, "ogg"), inst.checkParentData(node, parentNode, "thumbnail"), inst.checkParentData(node,
                    parentNode, "description"), null, null, null, inst.checkParentData(node, parentNode, "socialmedia"), inst.checkParentData(node, parentNode, "weblink"), inst.checkParentData(node, parentNode, "weblinktarget"), inst.checkParentData(node, parentNode, "weblinktext"), mediumw, mediumh, smallw, smallh);
                ...
                if (container.length > 0) {
                    ...
                    if (container.find(".lightboxdescription").length >
                        0) newItem[ELEM_DESCRIPTION] = container.find(".lightboxdescription").text()
                }
            ...
            inst.createMarkup = function() {
                ...
                styleCss += " #threedcarousel-html5-lightbox .html5-text {" + inst.options.titlecss + "}";
                styleCss += " #threedcarousel-html5-lightbox .html5-description {" + inst.options.descriptioncss + "}";
                styleCss += " #threedcarousel-html5-lightbox .html5-error {" +
                ...
                if (inst.options.titlestyle == "right") {
                    ...
                    styleCss += "#threedcarousel-html5-lightbox .html5-elem-wrap {height:100%;} #threedcarousel-html5-lightbox .html5-elem-data-box {width:" +
                ...
                if (inst.options.arrowsusefont) {
                    ...
                    if (inst.$nextfullscreen) {
                        inst.$nextfullscreen.append("<img alt='' src='" +
                ...
                if (inst.options.fullscreenmode || inst.options.closepos == "topright") {
                    ...
                    inst.$lightboxBox.append("<button id='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;" +
                        (inst.options.closepos == "outside" ? "margin-top:-16px;margin-right:-16px;margin-bottom:0;margin-left:0;padding:0;background:transparent;border:none;" : "") + "'></button>");
                ...
                else inst.$close.append("<img alt='' src='" + (inst.options.fullscreenmode || inst.options.closepos == "topright" ?
                    inst.options.fullscreencloseimage : inst.options.closeimage) + "'>");
            ...
            inst.showSocialButtons = function() {
                if (inst.options.showsocial) {
                    ...
                    if (inst.options.showtwitter) socialCode += '<div class="html5-social-btn html5-social-btn-action html5-social-twitter" style="' +
                        socialBtnCSS + '"><div class="mh-icon-twitter' + (inst.options.socialrotateeffect ? " html5-rotate" : "") + '" style="' + socialCSS + 'background-color:#03b3ee;"></div></div>';
                    if (inst.options.showpinterest) socialCode += '<div class="html5-social-btn html5-social-btn-action html5-social-pinterest" style="' + socialBtnCSS + '"><div class="mh-icon-pinterest' + (inst.options.socialrotateeffect ? " html5-rotate" : "") + '" style="' + socialCSS + 'background-color:#c92228;"></div></div>';
                    if (inst.options.showwhatsapp) socialCode += '<div class="html5-social-btn html5-social-btn-action html5-social-whatsapp" style="' +
                        socialBtnCSS + '"><div class="mh-icon-whatsapp' + (inst.options.socialrotateeffect ? " html5-rotate" : "") + '" style="' + socialCSS + 'background-color:#32cc65;"></div></div>';
                    if (inst.options.showtelegram) socialCode += '<div class="html5-social-btn html5-social-btn-action html5-social-telegram" style="' + socialBtnCSS + '"><div class="mh-icon-telegram' + (inst.options.socialrotateeffect ? " html5-rotate" : "") + '" style="' + socialCSS + 'background-color:#2d9ee2;"></div></div>';
                    if (inst.options.showdownload && (inst.currentElem[ELEM_TYPE] ==
                            0 || inst.currentElem[ELEM_TYPE] == 2 || inst.currentElem[ELEM_TYPE] == 5 || inst.currentElem[ELEM_TYPE] == 6)) {
                        ...
                        elemFile = elemFile.substring(0, elemUrl.indexOf("#"));
                        socialCode += '<div class="html5-social-btn html5-social-download" style="' + socialBtnCSS + '"><a href="' + elemUrl + '" download="' + elemFile + '"><div class="mh-icon-download' + (inst.options.socialrotateeffect ?
                            " html5-rotate" : "") + '" style="' + socialCSS + 'background-color:#37a569;"></div></a></div>'
                    }
                    socialCode += inst.options.extrasocialcodeafter;
                    socialCode += '<div style="clear:both;"></div></div>';
                    inst.$lightboxBox.append(socialCode);
                    $(".html5-social-btn-action", inst.$lightbox).click(function() {
                        var shareUrl = inst.options.sharemediaurl ? inst.currentElem[ELEM_HREF] : window.location.href + (window.location.href.indexOf("?") < 0 ? "?" : "&") + "wp3dcarousellightboxshare=" + encodeURIComponent(inst.currentElem[ELEM_HREF]);
                        var shareTitle =
            ...
            inst.showNavigation = function() {
                ...
                $("body").append("<div id='threedcarousel-html5-lightbox-nav' class='html5-nav' style='display:block;position:" + posType + ";" + posCss + "width:100%;height:" + inst.options.navheight + "px;z-index:9999999;" + (inst.options.navbgcolor ? "background-color:" + inst.options.navbgcolor + ";" : "") + "'>" + "<div class='html5-nav-container' style='position:relative;margin:" +
            ...
            inst.loadElem = function(elem) {
                ...
                if (inst.options.preload) {
                    ...
                    if (inst.options.prevElem >= 0 &&
                        inst.elemArray[inst.options.prevElem][ELEM_TYPE] == 0)(new Image).src = inst.elemArray[inst.options.prevElem][ELEM_HREF]
                }
            };
            ...
            inst.showTitle =
                function(t, description) {
                    ...
                    } else if (!inst.options.contentkeepratio && (elem[ELEM_TYPE] == 5 || elem[ELEM_TYPE] ==
                            7 || elem[ELEM_TYPE] == 10)) {
                    ...
                    var elemSize =
                        inst.getElemSize(elem, imgW, imgH);
            ...
            inst.finishDone = function() {
                ...
                $("head").find("style").each(function() {
                    if ($(this).data("creator") ==
                        "threedcarousel-html5-lightbox") $(this).remove()
                });
            ...
            inst.embedHTML5Video = function($container, src, autoplay, loopvideo, mutevideo, playsinline) {
                $container.html("<div style='display:block;width:100%;height:100%;position:relative;'><video class='html5-lightbox-video' width='100%' height='100%'" + (inst.options.html5videoposter && inst.options.html5videoposter.length > 0 ? "poster='" + inst.options.html5videoposter + "'" : "") + (autoplay ? " autoplay" : "") + (loopvideo ? " loop" : "") + (mutevideo ? " muted" : "") + (playsinline ? " playsinline" : "") + (inst.options.nativehtml5controls && !inst.options.videohidecontrols ?
                    " controls='controls'" : "") + (inst.options.nativecontrolsnodownload ? ' controlsList="nodownload"' : "") + " src='" + src + "'>" + (inst.options.showsubtitle && inst.options.vtturl ? '<track default src="' + inst.options.vtturl + '" kind="subtitles" srclang="' + inst.options.vttlang + '" label="' + inst.options.vttlabel + '">' : "") + "</video></div>");
                if (mutevideo) inst.options.defaultvideovolume = 0;
                if (!inst.options.nativehtml5controls && !inst.options.videohidecontrols) {
                    $("video", $container).data("src", src);
                    $("video", $container).wp3DLightboxHTML5VideoControls(inst.options.skinsfolder,
                        inst, ".html5-lightbox-video", inst.options.videohidecontrols, false, inst.options.defaultvideovolume, inst.options.nativecontrolsonfullscreen, inst.options.nativecontrolsnodownload, null, inst.options.showsubtitle, inst.options.vttline, inst.options.showsubtitlebydefault, inst.options.enableclick, inst.options.enablespacekey)
                }
            ...
            inst.showLightbox = function(type, href, title,
                width, height, webm, ogg, thumbnail, description, div, originalwidth, originalheight, socialmedia, weblink, weblinktarget, weblinktext, group, mediumwidth, mediumheight, smallwidth, smallheight) {
                ...
                inst.$lightbox.show();
                inst.adjustLightboxPos(inst.options.loadingwidth, inst.options.loadingheight);
                inst.loadElem(new Array(type, href, title, group, width, height, webm, ogg, thumbnail, description, div, originalwidth,
                    originalheight, socialmedia, weblink, weblinktarget, weblinktext, mediumwidth, mediumheight, smallwidth, smallheight))
            };
            ...
            inst.addItem = function(href,
                title, group, width, height, webm, ogg, thumbnail, description, mediatype, mediumwidth, mediumheight, smallwidth, smallheight) {
            ...
            inst.each(function() {
                ...
                if (typeof wp3dcarousellightbox_options != "undefined" && wp3dcarousellightbox_options) {
                    ...
                    if ("autoopenonce" in wp3dcarousellightbox_options) autoopenonce = wp3dcarousellightbox_options.autoopenonce;
                    if ("autoopenonceexpire" in wp3dcarousellightbox_options) autoopenonceexpire = wp3dcarousellightbox_options.autoopenonceexpire
                }
    ...
    (function($) {
        $.fn.wp3DLightboxHTML5VideoControls = function(skinFolder, parentInst, videoElem, hideControls, hidePlayButton, defaultVolume, fullscreenNativeControls, html5VideoNoDownload, skinImages, showsubtitle, vttline, showsubtitlebydefault, enableclick, enablespacekey) {
            ...
            var toggleVideoPlayPause = function() {
                if ($videoObj.get(0))
                    if ($videoObj.get(0).paused) $videoObj.get(0).play();
            ...
            if ($videoFSObj.get(0).requestFullscreen || $videoFSObj.get(0).webkitRequestFullScreen || $videoFSObj.get(0).mozRequestFullScreen || $videoFSObj.get(0).webkitEnterFullScreen || $videoFSObj.get(0).msRequestFullscreen) {
                ...
                if (!fullscreenNativeControls) $("head").append("<style type='text/css'>video" + videoElem +
            ...
            if (hd) {
                ...
                $videoHD.css({
                    ...
                    var paused = $videoObj.get(0).paused;
                    $videoObj.get(0).setAttribute("src", (isHd ? hd : src) + "#t=" + $videoObj.get(0).currentTime);
                    if (!paused) $videoObj.get(0).play();
                    else $videoObj.get(0).pause()
                })
            }
            if (showsubtitle) {
            ...
            if ($videoObj.get(0).volume === volume / 2 + 0.1) {
                ...
                $videoVolumeBar.css({
                    ...
                    width: 24,
                    height: 80,
                    "margin-bottom": Math.floor((BAR_HEIGHT -
                        BUTTON_SIZE) / 2),
                    "background-color": "#000000",
                    opacity: 0.7,
                    filter: "alpha(opacity=70)"
